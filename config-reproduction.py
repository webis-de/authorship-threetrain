...
'training_unlabelled': int(62*790*.01), # number of unlabelled documents to examine before re-computing classifiers
...
'scikit_balance_classes': True, #whether to balance the classes, so imbalanced training sets (with differing numbers of documents per author) get
