...
class DiskDict(MutableMapping):
	__slots__ = ['connection','cursor','tablename','requested_name','_keys','memory_cache']
...
if __name__ == '__main__':
	...
	with DiskDict('examplediskdict') as d:
		...
		d.moveToMemory(d.keys())
		pickled = pickle.dumps(d)
		unpickled = pickle.loads(pickled)
		print("found, again, these values: ",','.join(repr(x) for x in d.values()))
